...
### 3.1 Derechos de Propiedad Intelectual sobre el Contenido

Todo el contenido, marcas, logotipos, nombres comerciales, gráficos, interfaces de usuario, textos, imágenes, videos, software y cualquier otro material disponible en la plataforma **Artist Hive** es propiedad exclusiva de Artist Hive o de sus respectivos propietarios. Este contenido está protegido por las leyes nacionales e internacionales de propiedad intelectual, incluidos los derechos de autor y marcas registradas.
...
Si algún usuario o tercero considera que su propiedad intelectual ha sido utilizada en la plataforma de manera no autorizada o que infringe sus derechos, deberá notificar a **Artist Hive** a través de los medios de contacto dispuestos en la plataforma, proporcionando la siguiente información:

1. Una descripción detallada del contenido protegido por derechos de autor o propiedad intelectual que considera que ha sido infringido.
2. Información que permita identificar claramente el material infractor, como un enlace a la ubicación del mismo en la plataforma.
3. Una declaración de buena fe en la que el reclamante afirme que el uso disputado no está autorizado por el propietario de los derechos, su agente o la ley.
4. Una declaración bajo pena de perjurio de que la información proporcionada en la notificación es precisa y que el reclamante es el titular de los derechos o está autorizado para actuar en nombre del titular.
...
La plataforma puede contener enlaces, contenidos o referencias a materiales de terceros, como servicios externos o enlaces a sitios web. **Artist Hive** no reivindica derechos de propiedad sobre estos materiales de terceros, y su inclusión en la plataforma no implica ningún tipo de patrocinio o asociación con esos terceros.

El uso de los contenidos de terceros está sujeto a los términos y condiciones de los propietarios correspondientes, y los usuarios deben asegurarse de cumplir con las restricciones y obligaciones que se apliquen al utilizar dichos contenidos.
...
**Artist Hive** se compromete a proteger la privacidad de sus usuarios y a garantizar el cumplimiento de las normativas de protección de datos, como la Ley de Protección de Datos Personales en Colombia y cualquier regulación aplicable en otras jurisdicciones.
...
**Artist Hive** utilizará los datos recopilados exclusivamente para los fines establecidos en estos Términos y Condiciones, así como en la Política de Privacidad de la plataforma, que deberá ser consultada en detalle por los usuarios.

Los fines principales del tratamiento de los datos incluyen:

- Ofrecer un servicio personalizado y ajustado a los intereses de los usuarios.
...
Los usuarios tienen derecho a acceder, corregir, actualizar o eliminar sus datos personales en cualquier momento. Asimismo, pueden oponerse al procesamiento de sus datos o solicitar la portabilidad de los mismos cuando sea aplicable. Para ejercer estos derechos, los usuarios deben contactar a **Artist Hive** a través de los canales dispuestos en la plataforma.
...
**Artist Hive** no compartirá los datos personales de los usuarios con terceros, salvo en los siguientes casos:

- Cuando sea necesario para la prestación de los servicios contratados por los usuarios, como por ejemplo, proveedores de servicios tecnológicos o alianzas con proveedores externos que complementen la oferta premium de Artist Hive.
- En cumplimiento de una obligación legal o por requerimiento de una autoridad competente.
