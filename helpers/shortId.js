...
// Alfabeto alfanumérico puro (sin símbolos) para que el shortId sea seguro de
// usar en URLs sin encoding y fácil de compartir/leer en voz alta.
const ALPHABET =
  "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
const SHORT_ID_LENGTH = 10;

const nanoidGenerator = customAlphabet(ALPHABET, SHORT_ID_LENGTH);
...
function generateShortId() {
  return nanoidGenerator(SHORT_ID_LENGTH);
}
